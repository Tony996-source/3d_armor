...
armor:register_armor("3d_armor:helmet_leather", {
		...
		groups = {armor_head=1, armor_heal=0, armor_use=1000, flammable=1},
		armor_groups = {fleshy=5},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
	})
	armor:register_armor("3d_armor:chestplate_leather", {
		...
		groups = {armor_torso=1, armor_heal=0, armor_use=1000, flammable=1},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
	})
	armor:register_armor("3d_armor:leggings_leather", {
		...
		groups = {armor_legs=1, armor_heal=0, armor_use=1000, flammable=1},
		armor_groups = {fleshy=10},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
	})
	armor:register_armor("3d_armor:boots_leather", {
		...
		armor_groups = {fleshy=5},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
		groups = {armor_feet=1, armor_heal=0, armor_use=1000, flammable=1},
	})
end
...
if armor.materials.carbonfiber then
	armor:register_armor("3d_armor:helmet_carbonfiber", {
		...
		groups = {armor_head=1, armor_heal=15, armor_use=75, physics_speed=0.5, physics_jump=0.5},
		armor_groups = {fleshy=20},
		damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	})
	armor:register_armor("3d_armor:chestplate_carbonfiber", {
		...
		groups = {armor_torso=1, armor_heal=15, armor_use=75, physics_speed=0.5, physics_jump=0.5},
		armor_groups = {fleshy=20},
		damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	})
	armor:register_armor("3d_armor:leggings_carbonfiber", {
		...
		groups = {armor_legs=1, armor_heal=15, armor_use=75, physics_speed=0.5, physics_jump=0.5},
		armor_groups = {fleshy=20},
		damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	})
	armor:register_armor("3d_armor:boots_carbonfiber", {
		...
		groups = {armor_feet=1, armor_heal=15, armor_use=75, physics_speed=0.5, physics_jump=0.5},
		armor_groups = {fleshy=20},
		damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	})
end
...
if armor.materials.composite then
	armor:register_armor("3d_armor:helmet_composite", {
		...
		groups = {armor_head=1, armor_heal=17, armor_use=50, armor_water=1,},
	...
	armor:register_armor("3d_armor:chestplate_composite", {
		...
		groups = {armor_torso=1, armor_heal=17, armor_use=50},
		armor_groups = {fleshy=25},
		damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	})
	armor:register_armor("3d_armor:leggings_composite", {
		...
		groups = {armor_legs=1, armor_heal=17, armor_use=50},
		armor_groups = {fleshy=25},
		damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	})
	armor:register_armor("3d_armor:boots_composite", {
		...
		groups = {armor_feet=1, armor_heal=17, armor_use=50},
		armor_groups = {fleshy=25},
		damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	})
end
